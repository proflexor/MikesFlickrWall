...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		public function getTouchEvent(event:String):TUIOTouchEvent
		{
			...
			return new TUIOTouchEvent(event, true, false, x, y, localPoint.x, localPoint.y, dX, dY, oldX, oldY, TUIO_OBJECT, false,false,false, true, 0, TUIO_TYPE, ID, sID, angle);
		}
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// INTERNAL METHODS
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		internal function notifyCreated():void
		{
			if(TUIO_OBJECT)
			{
				try
				{
					...
					TUIO_OBJECT.dispatchEvent(new TUIOTouchEvent(TUIOTouchEvent.MOUSE_DOWN, true, false, x, y, localPoint.x, localPoint.y, dX, dY, oldX, oldY, TUIO_OBJECT, false,false,false, true, 0, TUIO_TYPE, ID, sID, angle));									
					TUIO_OBJECT.dispatchEvent(new TUIOTouchEvent(TUIOTouchEvent.MOUSE_OVER, true, false, x, y, localPoint.x, localPoint.y, dX, dY, oldX, oldY, TUIO_OBJECT, false,false,false, true, 0, TUIO_TYPE, ID, sID, angle));																		
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------		
		internal function notifyMoved():void
		{
			...
			for(var i:int=0; i<EVENT_ARRAY.length; i++)
			{
				...
				EVENT_ARRAY[i].dispatchEvent(new TUIOTouchEvent(TUIOTouchEvent.MOUSE_MOVE, true, false, x, y, localPoint.x, localPoint.y, dX, dY, oldX, oldY, EVENT_ARRAY[i], false,false,false, true, 0, TUIO_TYPE, ID, sID, angle));	
			}			
		}
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		internal function notifyRemoved():void
		{
			...
			{				
				localPoint = TUIO_OBJECT.parent.globalToLocal(new Point(x, y));				
				TUIO_OBJECT.dispatchEvent(new TUIOTouchEvent(TUIOTouchEvent.MOUSE_OUT, true, false, x, y, localPoint.x, localPoint.y, dX, dY, oldX, oldY, TUIO_OBJECT, false,false,false, true, 0, TUIO_TYPE, ID, sID, angle));				
				TUIO_OBJECT.dispatchEvent(new TUIOTouchEvent(TUIOTouchEvent.MOUSE_UP, true, false, x, y, localPoint.x, localPoint.y, dX, dY, oldX, oldY, TUIO_OBJECT, false,false,false, true, 0, TUIO_TYPE, ID, sID, angle));									
			    ...
			    if(dist < 20){
					...
					TUIO_OBJECT.dispatchEvent(new TUIOTouchEvent(TUIOTouchEvent.CLICK, true, false, x, y, localPoint.x, localPoint.y, dX, dY, oldX, oldY, TUIO_OBJECT, false,false,false, true, 0, TUIO_TYPE, ID, sID, angle));									
			    }			
			}			
			for(var i:int=0; i<EVENT_ARRAY.length; i++)
			{
				...
				{
					localPoint = EVENT_ARRAY[i].parent.globalToLocal(new Point(x, y));				
					EVENT_ARRAY[i].dispatchEvent(new TUIOTouchEvent(TUIOTouchEvent.MOUSE_UP, true, false, x, y, localPoint.x, localPoint.y, dX, dY, oldX, oldY, EVENT_ARRAY[i], false,false,false, true, 0, TUIO_TYPE, ID, sID, angle));								
				}
			}
		...
		{	
			...
			try {
				...
				} else if(TUIO_OBJECT != o) 
				{
					...
					{
						localPoint = TUIO_OBJECT.parent.globalToLocal(new Point(x, y));
						o.dispatchEvent(new TUIOTouchEvent(TUIOTouchEvent.MOUSE_OVER, true, false, x, y, localPoint.x, localPoint.y, dX, dY, oldX, oldY, TUIO_OBJECT, false,false,false, true, 0, TUIO_TYPE, ID, sID, angle));
					}
					TUIO_OBJECT = o;
				}
			} catch (e:Error)
